...
public class FavouriteDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foods = database.getReference("Favourite");
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(FavouriteDetail.this, "Added to Cart", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void getDetailFood(String foodId) {
        foods.child(foodId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                currentFood = dataSnapshot.getValue(Favourite.class);
